...
- [ ] 初期表示1スクロール内に「今日のやること」が含まれる
- [ ] 子どもタブ内から1タップで記録追加へ遷移できる
...
- [ ] 3.9-1〜3.9-6 の受け入れ条件を満たす
- [ ] KPIイベントが本番相当環境で取得できる
- [ ] `phase-plan-v2` から Step 3.9 詳細設計へリンクされている
- [ ] 主要画面のUI差分レビューが完了している
